...
class ModelBase():
    ...
    # ----------------------------------------
    def save_network(self, save_dir, network, network_label, epoch_label):
    ...
    # ----------------------------------------
    def save_optimizer(self, save_dir, optimizer, optimizer_label, epoch_label):
        save_filename = '{}_{}.pth'.format(epoch_label, optimizer_label)
        save_path = os.path.join(save_dir, save_filename)
